...
from content_gen import Environment
from content_gen.utils import logger
from content_gen.utils.const import AVATARS_ROOT
from content_gen.config import CONFIG
from content_gen.tasks import get_task
from content_gen.roles.role import Role

''' 
The Content class is designed to automate the creation of content
'''
...
class Content:
    ...
    '''
    Initializes the environment, requirements, and team.
    Reads tasks from the configuration and initializes them in the envrionment.
    '''
    def setup_environment(self, content=[]):
